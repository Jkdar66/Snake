import { Button, Rectangle, RoundRectangel, Scene, Size, Vector2 } from "./cool.js";
...
export class StartScene extends Scene {
    ...
    settingBtn: Button;
    optionBtn: Button;
    constructor(canvas: HTMLCanvasElement, gameScene: Scene) {
        super(canvas);
        this.background = new Rectangle(
            new Vector2(0, 0), new Size(this.canvas.width, this.canvas.height));
        const bckStyle = this.background.style;
        bckStyle.backgroundColor = "rgb(0, 0, 0)";
        this.startBtn = new Button(
            new Vector2(100, 100), new Size(150, 50), "Start"
        );
